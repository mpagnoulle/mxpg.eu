      ...
      >
        <div className="pt-4 pb-7 px-5 sm:pl-10 sm:pr-2 sm:pt-10 sm:max-w-[50%] flex flex-col h-full sm:group-even:ml-[18rem]">
          <h3 className="text-2xl font-semibold">
            {title}{" "}
            {link !== undefined && (
              <LuExternalLink className="inline-block text-xl -mt-1" />
            )}
          </h3>
        ...
        <Image
          ...
          width={600}
          height={400}
          className="absolute hidden sm:block top-8 -right-40 w-[28.25rem] rounded-t-lg shadow-2xl transition  group-hover:scale-[1.04] group-hover:-translate-x-3 group-even:group-hover:translate-x-3 group-even:right-[initial] group-even:-left-40"
        />
      </section>
    </motion.div>
  );
